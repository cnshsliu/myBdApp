  ...
  def main(args: Array[String]) {
    ...
    if (args.length < 2) {
      ...
      println(
        ...
        "Usage:WebPagePopularityValueCalculator zkserver1:2181, zkserver2:2181,zkserver3:2181 consumeMsgDataTimeInterval(secs)"
    ...
    val conf =
      ...
      new SparkConf().setAppName("Web Page Popularity Value Calculator")
    ...
    val popularityData = msgDataRDD.map { msgLine =>

      {
        ...
        val popValue: Double =
          ...
          dataArr(1).toFloat * 0.8 + dataArr(2).toFloat * 0.8 + dataArr(
